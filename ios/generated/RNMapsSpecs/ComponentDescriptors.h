...
using RNMapsHeatmapComponentDescriptor = ConcreteComponentDescriptor<RNMapsHeatmapShadowNode>;
using RNMapsLocalTileComponentDescriptor = ConcreteComponentDescriptor<RNMapsLocalTileShadowNode>;
